...
void loop() {
  ...
  RainbowLedButton(12, 0, ledColor);
  LedButtonOnOff(digitalRead(11), 1, ledColor);
  LedButtonOnOff(digitalRead(10), 2, ledColor);
  LedButtonOnOff(digitalRead(9), 3, ledColor);
  LedButtonOnOff(digitalRead(8), 4, ledColor);
  LedButtonOnOff(digitalRead(7), 5, ledColor);
}
...
// Changes led colors using potentiometer
